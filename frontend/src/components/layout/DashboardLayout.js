...
import {
  ...
  Zap, Shield, Brain, FileText, LogOut, Menu, X, ChevronRight,
  Activity, TrendingUp,
} from 'lucide-react'
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '12px 8px', borderTop: '1px solid var(--border-2)' }}>
          ...
          <button onClick={logout} className="nav-item" style={{ width: '100%', border: 'none', justifyContent: collapsed ? 'center' : 'flex-start' }}>
            <LogOut size={15} />
